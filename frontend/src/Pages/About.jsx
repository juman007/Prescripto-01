   ...
   return (
      <div>
         ...
         <div className="flex flex-col md:flex-row mb-20">
            <div className="border px-10 md:px-16 sm:py-16 flex flex-col gap-5 text-size[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-500 cursor-pointer">
               <b>EFFICIENCY:</b>
               <p>
            ...
            <div className="border px-10 md:px-16 sm:py-16 flex flex-col gap-5 text-size[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-500 cursor-pointer">
               <b>CONVENIENCE:</b>
               <p>
                  Access TO A Network Of Healthcare Professionals In Your Area.
               </p>
            </div>
            <div className="border px-10 md:px-16 sm:py-16 flex flex-col gap-5 text-size[15px] hover:bg-primary hover:text-white transition-all duration-300 text-gray-500 cursor-pointer">
               <b>PERSONALIZATION:</b>
